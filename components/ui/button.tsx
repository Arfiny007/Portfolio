  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-semibold transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        secondary:
          "bg-secondary text-secondary-foreground shadow-purple-glow hover:-translate-y-0.5 hover:bg-violet-400",
        outline:
          "border border-white/15 bg-white/5 text-foreground hover:-translate-y-0.5 hover:border-cyan-300/60 hover:bg-cyan-300/10",
        ghost:
